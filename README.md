...
This tool makes it easy to run python-based scripting of full workflows using [Agisoft Metashape](https://www.agisoft.com/) which is a proprietary structure-from-motion photogrammetry software program. It is an industry leader in creating orthomosaics, digital elevation models, and 3D point clouds from overlapping imagery (aerial, drone, or ground-based). Scripting increases the speed of image product creation and makes your workflows fully reproducible and documented. We demonstrate a [native installation workflow](#native-installation-workflow) as well as a [docker workflow](#docker-workflow). All of the python code has been written for you. You need to provide **1.** a Metashape license, **2.** your aerial images, and optionally **3.** [ground control points](#preparing-ground-control-points-gcps).
